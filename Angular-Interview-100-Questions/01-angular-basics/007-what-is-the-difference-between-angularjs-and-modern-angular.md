# What is the difference between AngularJS and modern Angular?
...
AngularJS is the 1.x JavaScript framework built around scopes, controllers, directives, and digest cycles. Modern Angular is a rewritten TypeScript-first, component-based platform with compiled templates, hierarchical DI, RxJS, signals, and modern tooling. In production, I choose it based on ownership, lifetime, testability, and failure behavior—not just because the syntax is convenient.

## Memory anchor

> **AngularJS: scope/controller/digest. Angular: component/DI/compiler.**

## 1. What problem does it solve?

AngularJS is the 1.x JavaScript framework built around scopes, controllers, directives, and digest cycles. Modern Angular is a rewritten TypeScript-first, component-based platform with compiled templates, hierarchical DI, RxJS, signals, and modern tooling.
...
AngularJS: scope/controller/digest. Angular: component/DI/compiler. Imagine the Angular screen as a set of small responsibilities. This concept tells you who owns a value or action, when it changes, and how the next part of the screen learns about it.

## 3. How it works internally

1. AngularJS repeatedly runs watchers in a digest loop. Modern Angular compiles templates, builds component views, and uses explicit reactive dependencies/change detection. They are different frameworks
2. Angular is not merely a later AngularJS version.
...
A bank can migrate screen-by-screen using a shell and APIs, isolate legacy AngularJS pages, introduce modern Angular feature routes, and remove shared mutable `$scope` state.
...
```ts
// Migration seam: keep the API contract stable while replacing one route at a time.
export interface PaymentApiPort { get(id: string): Observable<PaymentDto>; }
```
...
**Use it when:** Discuss when maintaining or planning migration from a 1.x application.

**Avoid or reconsider it when:** Do not call modern Angular “AngularJS”; the terminology signals whether you understand the platforms.
...
React is a UI library; Angular provides routing, DI, forms, HTTP, compilation, and conventions. AngularJS migration is architectural modernization, not a package upgrade.
...
- Attempting a big-bang rewrite without characterization tests
- mixing state across frameworks
- assuming directives migrate directly
- ignoring bundle and authentication boundaries.
...
- **Definition:** AngularJS is the 1.x JavaScript framework built around scopes, controllers, directives, and digest cycles. Modern Angular is a rewritten TypeScript-first, component-based platform with compiled templates, hierarchical DI, RxJS, signals, and modern tooling.
- **Remember:** AngularJS: scope/controller/digest. Angular: component/DI/compiler.
